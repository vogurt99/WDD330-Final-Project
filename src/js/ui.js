...
export function renderResults(books) {
    ...
    books.forEach((book) => {
        const cover = book.cover_i
            ...
            : "./src/public/images/placeholder_small.png"; // Placeholder image in case there is none
...
function showDetailModal(book) {
    ...
    const cover = book.cover_i
        ...
        : "./src/public/images/placeholder_large.png"; // Placeholder image in case there is none
    const authors = book.author_name ? book.author_name.join(", ") : "Unknown author";
